...
package io.clevver.data.api.designernews;

import java.util.List;
import java.util.Map;

import io.clevver.data.api.designernews.model.AccessToken;
import io.clevver.data.api.designernews.model.Comment;
import io.clevver.data.api.designernews.model.NewStoryRequest;
import io.clevver.data.api.designernews.model.Story;
import io.clevver.data.api.designernews.model.User;
